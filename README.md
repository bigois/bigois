<h1 align="center">Hi! 🤙 I'm Bigois!</h1>
<div align="center">
    <div title="Yes, that is exactly what you are reading 😂">
        <p><strong>Java Software Engineer | Full-Stack Developer</strong></p>
        <p>I build and maintain enterprise applications using Java, React, JavaScript, and TypeScript.</p>
        <p>I'm also a <strong>TOTVS Protheus Specialist</strong>, with experience in ADVPL/TL++, ERP customization, integrations, and automation. ☕</p>
    </div>
    <div align="center">
    ...
    <p>I have a degree in Information Systems, a postgraduate qualification in Java Architecture and Development, and an MBA in Software Engineering from FIAP 🎓</p>
    <hr>
    <p>Expert at casting forbidden Hogwarts spells to hunt down bugs - to infinity and beyond! 🧙</p>
    <p>Master at divining requirements hidden in clients' minds 🔮</p>
    <p>Certified firefighter from the FireRangers Academy in Ontario, Canada, with a knack for putting out software fires that come out of nowhere and vanish just as quickly 👨‍🚒</p>
    <hr>
</div>
<div align="center">
    <a href="https://linkedin.com/in/bigois" target="_blank">
        <img title="Connect with me on LinkedIn 😉" src="badges\linkedin.svg">
    </a>
    <a href="https://www.youtube.com/@organacode" target="_blank">
        <img title="Check out my YouTube channel 📰" src="badges\youtube.svg">
    </a>
    <a href="https://bigois.medium.com" target="_blank">
        <img title="Read my Medium articles ✍️" src="badges\medium.svg">
    </a>
    <a href="https://api.whatsapp.com/send?phone=5511954226844" target="_blank">
        <img title="Got a question? Message me on WhatsApp! 📳" src="badges\whatsapp.svg">
    </a>
    <a href="mailto:guilherme.bigois@organacode.com.br" target="_blank">
        <img title="Want to work together? Send me an email! 📨" width="111px" height="28px" src="badges/email.svg">
    </a>
</div>
<h2 align="center">Technologies I use (or have used) 👨‍💻</h2>
<div align="center">
    <details>
        ...
        <img title="Node.js" width="40px" height="40px" src="images/code/nodejs.svg">
    ...
    <details>
        <summary>When your app needs to fit in your pocket (mobile development)</summary>
    ...
    <details>
        <summary>Where the magic happens (IDEs)</summary>
    ...
    <details>
        <summary>Things the intern accidentally turns off (infrastructure)</summary>
    ...
    <details>
        <summary>The things that keep us sane (organization and agility)</summary>
    ...
    <details>
        <summary>Everything else I couldn't categorize (other technologies)</summary>
